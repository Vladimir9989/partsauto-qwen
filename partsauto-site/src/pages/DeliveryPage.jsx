          ...
          <div className={styles.content}>
            <div className={styles.paymentSection}>
              ...
              <ul className={styles.paymentList}>
                ...
                <li>Перевод на расчетный счет компании (без НДС)</li>
                <li>Оплата наличными в офисе компании</li>
                <li>Оплата картой через терминал в офисе компании</li>
              </ul>
            </div>
            ...
            <div className={styles.deliverySection}>
              ...
              <div className={styles.localDeliverySection}>
                ...
                <p>Вы можете заказать доставку по Екатеринбургу до адреса каждый день в период с <strong>18:00 до 22:00</strong></p>
              ...
              <div className={styles.priceBlock}>
                <h3 className={styles.subtitle}>Стоимость доставки до ТК:</h3>
                <ul className={styles.priceList}>
                  <li>Габарит — 300 руб.</li>
                  <li>Негабарит — 500 руб.</li>
                </ul>
              </div>
